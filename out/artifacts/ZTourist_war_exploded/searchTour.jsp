                                        ...
                                        <s:iterator value="%{listTour}">
                                            <div class="tg-populartour tg-populartourvtwo">
                                                <figure>
                                                    ...
                                                    <s:a href="%{viewTourLink}"><img style="width: 401px; height: 285px;" src="<s:property value="%{titleImage}"/>" alt="tour image"></s:a>
                                                    </figure>
                                                    <div class="tg-populartourcontent">
                                                        <div class="tg-populartourtitle">
                                                            <h3 style="color: #00aff0"><s:a href="%{viewTourLink}"><s:property value="%{name}"/></s:a></h3>
                                                            <br/>
                                                            <h5>
                                                    ...
                                                    <div class="tg-description">
                                                        <p> - <s:property value="%{desc}"/> <s:a cssStyle="text-decoration:none;" href="%{viewTourLink}">View more...</s:a></p>
                                                        </div>
