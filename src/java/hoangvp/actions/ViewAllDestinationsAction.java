 ...
 * @author Danze
 */
public class ViewAllDestinationsAction extends ActionSupport {

    private static Logger logger = LogManager.getLogger(ViewAllDestinationsAction.class.getName());

    private Integer skipPage, page;
    private int totalPages;
    private List<PlaceDTO> listPlace;

    public ViewAllDestinationsAction() {
    }
