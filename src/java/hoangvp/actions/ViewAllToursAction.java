 ...
 * @author Danze
 */
public class ViewAllToursAction extends ActionSupport {

    private static Logger logger = LogManager.getLogger(ViewAllToursAction.class.getName());

    private Integer skipPage, page;
    private int totalPages;
    private List<TourDTO> listTour;

    public ViewAllToursAction() {
    }
